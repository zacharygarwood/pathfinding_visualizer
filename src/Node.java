/**
 * The Node Class is used to create the individual nodes that is to be searched
 */
...
public class Node {
    ...
    //F Cost = G cost + H cost // G cost = distance from starting node // H Cost = distance from end node
